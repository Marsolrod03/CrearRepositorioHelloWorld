...
class MoviesDeleteDatabaseUseCaseTest {

    private lateinit var movieRepository: MovieRepository
    private lateinit var deleteDatabaseUseCase: MoviesDeleteDatabaseUseCase

    @BeforeEach
    fun setUp() {
        movieRepository = mockk(relaxed = true)
        deleteDatabaseUseCase = MoviesDeleteDatabaseUseCase(movieRepository)
    }
