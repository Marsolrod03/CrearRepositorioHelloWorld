...
public abstract class Hilt_FragmentHome<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentHome_GeneratedInjector) this.generatedComponent()).injectFragmentHome(UnsafeCasts.<FragmentHome>unsafeCast(this));
    }
  }
